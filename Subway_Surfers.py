 ...
 #   ok, frame = camera_video.read()
  #  ok, frame_1 = camera_video.read()
   ...
   # if not ok:
    ...
    #frame_1_height, frame_1_width, _ = frame_1.shape
    #frame_0_height, frame_0_width, _ = frame_0.shape
    
    # Perform the pose detection on the frame.
    #frame, results = detectPose(frame, pose_video, draw=True)
    #frame_1, results = detectPose(frame, pose_video, draw=True)
    #frame_0, results = detectPose(frame, pose_video, draw=True)
    ...
    # Check if the pose landmarks in the frame are detected.
     ...
     #   frame, _ = checkJumpCrouch(frame, results, draw=True)
      #  frame_1, _ =checkLeftRight(frame, results, draw=True)
       # frame_0, _ = checkHandsJoined(frame, results, draw=True)
       
                
    # Display the frame.
    #cv2.imshow('Verticial Movements', frame)
    #cv2.imshow('Horizontal Movements', frame_1)
    #cv2.imshow('Horizontal Movements', frame_0)
